...
/**
 * @brief  Imprime o caminho de menor dist̢ncia. Execute Bellman-Ford previamente.
 * @param	grafo: um grafo
 * @param  fonte: v̩rtice fonte utilizando em Bellman-Ford
 * @param  destino: v̩rtice destino. Deve haver pelo menos um caminho entre fonte e destino
 *
 * @retval Nenhum
 */
